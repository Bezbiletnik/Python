'''Program that generate pseudonyms'''
import random

def main():
    '''Randomly choose variable from tuples and show on result'''
    ...
    first = ('Baby Oil', 'Bad News', 'Big Burps', "Bill 'Beenie-Weenie'",
            ...
            'Mergatroid', '"Mr Peabody"', 'Oil-Саn', 'Oinks',
    ...
    last = ('Appleyard', 'Bigmeat', 'Bloominshine', 'Boogerbottom',
            ...
            'Stroganof', 'Sugar-Gold', 'Swackhamer', 'Tippins',
